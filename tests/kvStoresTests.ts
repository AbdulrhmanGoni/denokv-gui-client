...
export function kvStoresTests() {
  ...
  test("Create local Kv Stores", async ({ page }) => {
    ...
    const localTypeSelectItem = page.locator('div[data-slot="select-item"]', {
      hasText: "local",
    });
    ...
    await expect(
      newKvStoreCard.locator("p", { hasText: testingKvStore.name }),
    ).toHaveText(testingKvStore.name);
    ...
    await expect(
      anotherNewKvStoreCard.locator("p", { hasText: anotherNewKvStore.name }),
    ).toHaveText(anotherNewKvStore.name);
  });
  ...
  test("Delete a Kv Store", async ({ page }) => {
    ...
    await anotherNewKvStoreCard
      .locator('button[data-slot="dropdown-menu-trigger"]', {
        has: page.locator("svg.lucide-ellipsis-vertical"),
      })
      .click();
    await page
      .locator('div[data-slot="dropdown-menu-item"]', { hasText: "Delete" })
      .click();
    await page
      .locator('button[data-slot="alert-dialog-action"]', { hasText: "Delete" })
      .click();
  ...
  test("Create a remote Kv Store", async ({ page }) => {
    ...
    const nameInput = page.locator("input#name");
    const typeSelectButton = getTypeSelectButton(page);
    const remoteTypeSelectItem = page.locator('div[data-slot="select-item"]', {
      hasText: "remote",
    });
    ...
    await expect(
      page.locator("#kv-stores-grid > div", {
        has: globeIcon,
  ...
  test("Create a bridge Kv Store", async ({ page }) => {
    ...
    const nameInput = page.locator("input#name");
    const typeSelectButton = getTypeSelectButton(page);
    const bridgeTypeSelectItem = page.locator('div[data-slot="select-item"]', {
      hasText: "bridge",
    });
    const urlInput = page.locator("input#url");
...
function getTypeSelectButton(page: Page) {
  return page.locator('button[data-slot="select-trigger"]', {
