<script lang="ts">
  ...
  import BrowsingParamsForm from "$lib/features/kv-browser/browsing-params/BrowsingParamsForm.svelte";
  import SavedBrowsingParamsList from "$lib/features/kv-browser/browsing-params/SavedBrowsingParamsList.svelte";
