...
export class KvStoresServiceModule implements AppModule {
    enable(_context: ModuleContext): void {
        ...
        ipcMain.handle("kvStoresService:update", async (_, kvStore: KvStore, changes: EditKvStoreInput) => {
        ...
        ipcMain.handle("kvStoresService:renameDefaultLocalKvStore", async (_, store: KvStore, newName: string) => {
        ...
        ipcMain.handle("kvStoresService:testKvStoreConnection", async (_, kvStore: TestKvStoreParams) => {
