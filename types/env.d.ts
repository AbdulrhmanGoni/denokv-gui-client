...
/**
 * Describes all existing environment variables and their types. Required for Code
 * completion/intellisense and type checking.
 *
 * Note: To prevent accidentally leaking env variables to the client, only variables
 * prefixed with `VITE_` are exposed to your Vite-processed code.
 *
